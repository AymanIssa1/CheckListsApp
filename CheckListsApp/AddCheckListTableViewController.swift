//
//  AddCheckListTableViewController.swift
//  CheckListsApp
//
...
class AddCheckListTableViewController: UITableViewController {

    public weak var delegate:CheckListItemViewControllerDelegate?
    @IBOutlet weak var editText: UITextField!
    
    @IBAction func addButton(_ sender: Any) {
        let checkListItem = CheckList(checkListName: editText.text!)
